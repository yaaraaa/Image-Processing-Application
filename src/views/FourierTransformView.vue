    ...
    <nav class="navbar is-light">
      <div class="navbar-brand">
        <div class="navbar-item">
            <div class="title  is-4">Fourier transform</div>
        </div>
        <div class="navbar-item">
...
export default {
    ...
    methods: {
        ...
        // axios.post(*function path from backend*, image) // passes the uploaded image to the fourier transform function in the backend
            .then(res => {
