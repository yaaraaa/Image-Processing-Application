    ...
    <nav class="navbar is-light">
      <div class="navbar-brand">
        <div class="navbar-item">
            <div class="title  is-4">Sobel filter</div>
        </div>
        <div class="navbar-item">
        ...
        <div class="navbar-item">     
            <div class="control">
                <div class="h3 is-6">Filter size</div>
                <input type="text" class="input" v-model="filterSize">
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        // axios.post(*function path from backend*, data) // passes the uploaded image and filter size to the sobel function in the backend
            .then(res => {
